...
from meeting06.datasets import DatasetFlickrImageNumpyMmap, DatasetFlickrImageZarr, DatasetFlickrImage
...
def main():
    ...
    datasets = [
        DatasetFlickrImageNumpyMmap(root='../data'),
        DatasetFlickrImageZarr(root='../data', chunks=(BATCH_SIZE, None)),
        DatasetFlickrImage(root='../data', transform=transform),
    ]
